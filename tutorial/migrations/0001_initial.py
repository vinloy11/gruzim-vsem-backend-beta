    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='tutorial.Actor', verbose_name='актеры')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tutorial.Category', verbose_name='Категория')),
                ('directors', models.ManyToManyField(related_name='film_director', to='tutorial.Actor', verbose_name='режиссер')),
                ('genres', models.ManyToManyField(to='tutorial.Genre', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tutorial.Reviews', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
